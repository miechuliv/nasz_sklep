  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a>
          ...
          <a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a>
          <a href="#tab-image"><?php echo $tab_image; ?></a>
          <?php /* <a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a> */ ?>
          <?php /* <a href="#tab-prices"><?php echo $this->language->get('tab_prices'); ?></a> */?>
	   </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
                <td><?php echo $this->language->get('text_subcategory_name'); ?></td>
                <td><input type="text" name="subcategory_name" value="<?php echo $subcategory_name; ?>" /></td>
            </tr>

            <tr>
                <td><?php echo $this->language->get('text_original_model'); ?></td>
                <td><input type="text" name="original_model" value="<?php echo $original_model; ?>" /></td>
            </tr>

            <tr>
                <td><?php echo $this->language->get('text_original_price'); ?></td>
                <td><input type="text" name="original_price" value="<?php echo $original_price; ?>" /></td>
            </tr>

            <tr>
                <td><?php echo $this->language->get('text_buy_price'); ?></td>
                <td><input type="text" name="buy_price" value="<?php echo $buy_price; ?>" /></td>
            </tr>
        ...
        <div id="tab-quantity-discount" style="display: none;">
            ...
            <table>
                ...
                <?php if($product_quantity_discount){ ?>
                <?php foreach($product_quantity_discount as $discount){ ?>
                <tr class="remuwator">
                <td><input type="text" name="product_quantity_discount[<?php echo $product_quantity_discount_row; ?>][from]" value="<?php echo $discount['from'] ?>" /></td>
                <td><input type="text" name="product_quantity_discount[<?php echo $product_quantity_discount_row; ?>][to]" value="<?php echo $discount['to'] ?>" /></td>
                <td><input type="text" name="product_quantity_discount[<?php echo $product_quantity_discount_row; ?>][percent]" value="<?php echo $discount['percent'] ?>" /></td>
                ...
                <script type="text/javascript">
                    ...
                    function addProductQuantitydiscount(elem)
                    {
                        ...
                        html += '<td><input type="text" name="product_quantity_discount['+product_quantity_discount_row+'][from]" value="'+from.val()+'" /></td>';
                        html += '<td><input type="text" name="product_quantity_discount['+product_quantity_discount_row+'][to]" value="'+to.val()+'" /></td>';
                        html += '<td><input type="text" name="product_quantity_discount['+product_quantity_discount_row+'][percent]" value="'+percent.val()+'" /></td>';
            ...
            <table class="form">
              ...
              <tr>
                ...
                <td>
                    ...
                    <input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" /></td>
              </tr>
              <?php } ?>
