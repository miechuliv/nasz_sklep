		...
		if ($product_info) {
            ...
            if(!empty($this->data['product_quantity_discount']))
            {
                foreach($this->data['product_quantity_discount'] as $key => $discount)
                {
                    ...
                    {
                        $druk = $this->model_catalog_grupy_druku->getProductKosztDruku($this->request->get['product_id'],$discount['from'],$i);
...
/*	
	...
	*/
    ...
    public function getQuantityDiscount()
    {
        ...
        $percent = $this->model_catalog_product_quantity_discount->getAviableDiscountByProductId($this->request->post['product_id'],$this->request->post['quantity']);
